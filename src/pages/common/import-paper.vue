<template>
  <div class="pl-main">
    <div class="pl-main-inner">
      <div class="pl-twocolbox">
        <div class="pl-astable xtwocol">
          <div class="pl-astable-col">
            <div class="pl-title" style="margin-bottom:-1px;">
              <span class="pl-title-label">导入文件信息</span>
              <div class="pl-title-right">
                <el-button size="medium" type="default">格式化说明</el-button>
              </div>
            </div>

            <div class="pl-importbox" v-pl-to-bottom="100">
              导入的试题内容
            </div>
          </div>
          <div class="pl-astable-col">
            <div class="pl-title" style="margin-bottom:-1px;">
              <span class="pl-title-label">试卷信息</span>
            </div>

            <!-- 题型 -->
            <div class="pl-importbox" v-pl-to-bottom="100">
              <div class="pl-paperdetail-param xtitle">2018年03月24日189****0518的初中数学组卷</div>
        ...
        <div class="pl-fixfooter" v-pl-sticky:bottom="80">
          ...
          <el-button type="info">解析试卷</el-button>
