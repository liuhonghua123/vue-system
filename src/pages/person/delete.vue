<template>
  <div class="pl-sidelayout-right">
    ...
    <div class="pl-card xp" style="min-height:640px;">
      <div class="pl-title">
        <span class="pl-title-label">试卷删除记录</span>
        <div class="pl-title-right">
          <label class="c-9">其50套试卷，排序:</label>
          <a class="pl-link2">删除时间</a>
        </div>
      </div>
      <div class="pl-notebar" style="margin-top:-20px;">一周内删除试卷可以恢复</div>
      <ul class="pl-paperinfos">
        <li class="pl-paperinfo">
          ...
          <div class="pl-paperinfo-btns">
            <el-button size="medium">恢复</el-button>
          </div>
        </li>
        <li class="pl-paperinfo">
